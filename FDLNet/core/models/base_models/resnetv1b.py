...
def resnet50_v1s(pretrained=False, root='~/.torch/models', **kwargs):
    ...
    if pretrained:
        ...
        # 改变resnet50来源为本地
        model.load_state_dict(torch.load('/home/ma-user/work/ymxwork/NIPS/YOLO-World/FDLNet/core/models/resnet50-25c4b509.pth'), strict=False)
    return model
...
def resnet101_v1s(pretrained=False, root='~/.torch/models', **kwargs):
    ...
    if pretrained:
        from ..model_store import get_resnet_file
        # 改变resnet101来源为本地
        model.load_state_dict(torch.load('/home/ma-user/work/ymxwork/NIPS/YOLO-World/FDLNet/core/models/resnet101-5d3b4d8f.pth'), strict=False)
    return model
