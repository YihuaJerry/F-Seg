...
parser.add_argument('--input-pic', type=str, default='/home/ma-user/work/ymxwork/NIPS/YOLO-World/datasets/NightCity/images/val/Chicago_0001.png',
                    help='path to the input picture')
parser.add_argument('--outdir', default='/home/ma-user/work/ymxwork/NIPS/YOLO-World/FDLNet/scripts', type=str,
...
def demo(config):
    ...
    #model = get_segmentation_model(args.model, local_rank=args.local_rank, pretrained=True, root=args.save_folder).to(device)
