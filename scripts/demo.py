...
parser.add_argument('--input-pic', type=str, default='datasets/NightCity/images/val/Chicago_0001.png',
                    help='path to the input picture')
parser.add_argument('--outdir', default='scripts', type=str,
...
def demo(config):
    ...
    checkpoint=torch.load('runs/ckpt/trained_model.pth',map_location=device)
