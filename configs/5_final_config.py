...
# custom_imports = dict(imports=['/home/ma-user/work/ymxwork/NIPS/YOLO-World/FDLNet/core/models/yolo_world'],
...
text_channels = 512
neck_embed_channels = [128, 256, 512 // 2]
neck_num_heads = [4, 8,  512// 2 // 32]
base_lr = 2e-3
weight_decay = 0.05 / 2
train_batch_size_per_gpu = 16
text_model_name = '/home/ma-user/work/ymxwork/NIPS/YOLO-World/third_party/clip-vit-base-patch32'
...
#                  data_root='/home/ma-user/work/ymxwork/NIPS/YOLO-World/data/coco/',
#                  test_mode=True,
...
#                      ann_file='/home/ma-user/work/ymxwork/NIPS/YOLO-World/data/coco/lvis_v1_minival_inserted_image_name.json',
#                      metric='bbox')
