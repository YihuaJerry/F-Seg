...
load_from = '/home/ma-user/work/ymxwork/NIPS/YOLO-World/pretrained_weights/yolo_world_seg_l_dual_vlpan_2e-4_80e_8gpus_seghead_finetune_lvis-5a642d30.pth'
...
coco_train_dataset = dict(
    ...
    dataset=dict(type='YOLOv5LVISV1Dataset',
                 data_root='/home/ma-user/work/ymxwork/NIPS/YOLO-World/datasets/NightCity/images/train',
                 ann_file='/home/ma-user/work/ymxwork/NIPS/YOLO-World/data/texts/lvis_v1_base_class_captions.json',
                 data_prefix=dict(img=''),
                 filter_cfg=dict(filter_empty_gt=True, min_size=32)),
    class_text_path='/home/ma-user/work/ymxwork/NIPS/YOLO-World/data/texts/lvis_v1_class_texts.json',
...
coco_val_dataset = dict(
    ...
    type='MultiModalDataset',
    dataset=dict(type='YOLOv5LVISV1Dataset',
                 data_root='/home/ma-user/work/ymxwork/NIPS/YOLO-World/datasets/NightCity/images/val',
                 test_mode=True,
                 ann_file='/home/ma-user/work/ymxwork/NIPS/YOLO-World/data/texts/lvis_v1_base_class_captions.json',
                 data_prefix=dict(img=''),
...
val_evaluator = dict(type='mmdet.LVISMetric',
                     ann_file='/home/ma-user/work/ymxwork/NIPS/YOLO-World/data/texts/lvis_v1_class_texts.json',
                     metric=['bbox', 'segm'])
